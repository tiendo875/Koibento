<%-- 
    Document   : Admin
    Created on : Jul 27, 2020, 11:29:52 PM
    Author     : XPS 13
--%>
                        ...
                        <div class="col-md-7 col-xs-12">
                            <form action="${pageContext.request.contextPath}/SearchController" method="POST" id="Search-dropdown">
                                <div class="input-group">
                                    ...
                                    <button type="submit" value="Search" class="btn-search" type="button" name="Search">
                                        <i class="fa fa-search"></i>

                                    </button>
<!--                                    <input type="text" class="form-control" placeholder="Giá tiền?" name="seach-price" id="search-dropdown-input">-->

<!--                                    <button type="submit" name="sort"> Sort Price </button>-->
                                </div>
                            </form>
                        </div>
                ...
                <div class="row row-btn-group">
                    <div class="col-sm-12 col-xs-12">
                        <ul class="button-tab-pannel button-group">
                            ...
                            <li>
                                <a class="tab-link" href="http://localhost:8080/KoiBento/AddProduct.jsp">ADD PRODUCT</a>
                            </li>
                            <li>
                                <a class="tab-link" href="#tab-3">ACCOUNT</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="box-shadow">
                                ...
                                <div class="box-food-text text-center">
                                    ...
                                    <div class="add-to-cart-food">
                                        <a href="http://localhost:8080/KoiBento/EditProduct.jsp" class="add-to-cart-a-food button-food-cart-more">EDIT PRODUCT</a>  
                                    </div>
                                </div>
                            </div>
                        </div>
