<%-- 
    ...
    Created on : Jul 28, 2020, 12:01:19 AM
    Author     : XPS 13
--%>
...
<!--                                <li style="display: inline-block">
                                ...
                                <li style="display: inline-block">
                                    <a href="http://localhost:8080/KoiBento/Menu.jsp#">MENU /</a>
                                </li>
                    ...
                    <div class="row row-center">
                        <div class="col-sm-6 col-xs-12">
                            <form  class="check-out check-out-peyment" method="post" action="" name="check-peyment">
                                <div class="title-header">
                                    <h2 class="content-title"style="color: #FFC312">Edit Product</h2>
                                </div>
                                <div class="input-payment-contain">
                                    ...
                                    <p class="form-phone form-first" id="phone-form">
                                        <label for="billing-phonen" style="color: #FFC312">Loại sản phẩm</label>
                                        <input type="text" style="display:block;
                                               width:100%;
                                               height:40px;
                                               padding:10px;
                                    ...
                                    <br>
                                    <p>
                                        <button type="submit" name="submit" value="Thanh Toán">Edit Product</button>
                                    </p>
                                </div>
                            </form>
                        </div>
